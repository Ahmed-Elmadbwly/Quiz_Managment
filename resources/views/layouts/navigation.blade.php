    ...
    <header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
        <div class="flex ml-5 items-center gap-2 sm:gap-4 lg:hidden">
            <!-- Hamburger Toggle BTN -->
            <button class="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden" @click.stop="sidebarToggle = !sidebarToggle" fdprocessedid="gjqrx">
        <span class="relative block h-5.5 w-5.5 cursor-pointer">
          ...
          <span class="du-block absolute right-0 h-full w-full rotate-45">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="{{route('dashboard')}}">
                <img src="{{url('src/images/logo/logo-icon.svg')}}" alt="Logo">
            </a>
        </div>
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                        ...
                        <span class="h-12 w-12 rounded-full">
                                    <img class="h-12 w-12 rounded-full" src="{{Storage::url("images/".Auth::user()->image)}}" alt="User" />
                                </span>
